...
export default function Feature() {
  return (
    <>
      <div className="relative grid w-11/12 gap-2 mx-auto mb-4 feature lg:grid-cols-3">
        <div className="col-span-1">
          <div className="sticky top-[150px]">
            ...
            <p className="pt-2 text-gray-600">
              Start Working with Finest GST Billing Software and stay ahead from
        ...
        <div className="grid w-9/12 col-span-2 gap-4 ml-auto sm:grid-cols-2">
          <div className="feature-card">
            <h1 className="px-[25px] text-xl text-center">GST Compliance</h1>
            <p className="px-[25px] text-center">
              The cancer in disguise problem for a Businessman will be sorted.
              Our aim is to make our client satisfied and stress free from all
          ...
          <div className="feature-card">
            ...
            <p className="px-[25px] text-center">
              Be digital with digitalized India. No need to use paper and pen.
              Share invoices in one go via WhatsApp, Email etc. in PDF format.
            </p>
            <div className="card-footer mt-7">
