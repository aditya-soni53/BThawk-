...
export default function     () {
  return (
   <>
         <div className='md:w-11/12 mx-auto grid md:grid-cols-2 mt-14'>
            <div className="mobile-device bg-[#000000] md:p-14 p-6 text-white rounded-md">
                <p>Mobile App</p>
                <h1 className='text-xl'>Carry your accounts <br />
                wherever you go!</h1>
            ...
            <p className='text-[#5152B0]'>desktop App</p>
                <h1 className='text-xl text-[#5152B0]'>A Simple, Secure standalone <br />
                Desktop Solution!</h1>
