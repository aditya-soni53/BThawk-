    ...
    <>
      ...
      <div className='w-11/12 mx-auto grid lg:grid-cols-3 mt-4'>
        <div className='grid lg:grid-cols-2 grid-cols-3  apps gap-4 place-content-center'>
          ...
          <button
            className={`p-4 app-1 border-b-2 rounded-t-lg ${activeTab === "fse"
              ? "active"
              : "hover:text-gray-600  dark:hover:text-gray-300"
              }`}
          ...
          <button
            className={`app-1 p-4 border-b-2 rounded-t-lg ${activeTab === "retailer"
              ? "active"
              : "hover:text-gray-600"
              }`}
            ...
            <div className="grid md:grid-cols-2 md:w-11/12 mx-auto" role="tabpanel" aria-labelledby="admin-tab" >
              ...
              <div className="app-cards">
                <div className="appcard-1">
                  <h3 className='text-xl text-center text-[#22249B]'>Admin App and Dashboard</h3>
                  <p className='text-center'>Admin App gives you the supremacy to maintain a hawk eye on the activities of your FSEs.</p>
                  <ul className='mt-2'>
                    <li className='mt-2 flex'> <img className='mr-2' src={Listicon} alt="" />Prevents stock leakage.</li>
                    <li className='mt-2 flex'> <img className='mr-2' src={Listicon} alt="" />Correct tracking of sales.</li>
                    <li className='mt-2 flex'> <img className='mr-2' src={Listicon} alt="" />More focus on core business instead of compliance</li>
                  </ul>
