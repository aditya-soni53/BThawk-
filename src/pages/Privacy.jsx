...
import { CollectData, IntroductionData, Privacydata } from "../helper/privacyData";
    ...
    <section className="privacy_policy-section">
      ...
      <div className="container mx-auto mt-10 mb-10">
        ...
        <div className="p-6 shadow-inner">
          ...
          <ol className="mt-4 list-decimal ">
            ...
            <div className="mt-4">
              <p className="text-base">
                ...
                with, or make your connection with the Services. Such collected
                data includes:
              </p>
              <p className="mt-4">
              ...
              <ul>
                ...
                <li className="mt-3">
                  ...
                  access to the App and Services. In certain scenarios, we need
                  to collect certain data as required by law, or under the
                  Terms. If you fail to provide us with that data as and when
                  requested by us, we will not be able to perform our
                  ...
                  cancel or limit your access to the Services (or part thereof).
                </li>
              </ul>
            </div>
          </ol>
          ...
          <p className="mt-3">
            We use different methods to collect and process personal data about
            you. This includes:
          </p>
          <ul className="">
            <li className="mx-4 mt-4 list-disc">
              ...
              App). It includes information you provide when you register to use
              the Services, use an App feature, share data through the App, or
              when you report a problem with the App and our Services. If you
          ...
          <p className="text-lg">
            Please note that we do not have any control over your personal data
            that you may choose to make publicly available. For an example, if
            you post reviews, comments, or messages on the public sections of
            the app or on app store or play store, you’ll be doing that at your
            own risk. We are not responsible for third party misuse of any such
            data.
          </p>
          ...
          <ul className="">
            ...
            <li className="mx-4 mt-4 list-disc">
              ...
              registering with our app, you authorize us. This ensures that you
              are aware of all the features and services of the application.
            </li>
            <li className="mx-4 mt-4 list-disc">
          ...
          <ul className="">
            <li className="mx-4 mt-4 list-disc">
              You agree and acknowledge that any and all information concerning
              to you, Whether or not you provide it directly to us, but not
              limited to personal correspondence such as emails, instructions
              from you, etc. may be collected, compiled and shared by us ONLY In
              order to deliver the services to you.
            </li>
            <li className="mx-4 mt-4 list-disc">
              ...
              applying this policy or the terms, or in order to comply with any
          ...
          <p className="mt-3">
            ...
            to access and correct inaccurate and imperfect data, that subject to
          ...
          <p className="mt-3">
            ...
            retained by us as long as it is needed to fulfill the stated purpose
            of the application and for a reasonable period after the termination
            of your account on the app or access to the services.
          </p>
          ...
          <ul className="">
            <li className="mx-4 mt-4 list-disc">
              We keep our privacy policy under regular reviews and may change it
              over time.
            </li>
            <li className="mx-4 mt-4 list-disc">
              The terms of this policy may change and if it does then these will
              be posted on the page, or notified to you by the mail. The new
              policy may be displayed on the screen and you may be needed to
              accept the changes to keep in use of app and services.
            </li>
          </ul>
          ...
          <p className="mt-2">
            <span className="font-bold">Address:</span> 519, 5th Floor, JMD Megapolis IT Park, Sohna Road, Gurugram, Haryana
          </p>
          <p className="mt-2">
            <span className="font-bold">Email Address:</span> <a className="text-[#E45325] hover:underline" href="mailto:Zeeshan@bthawk.com">Zeeshan@bthawk.com</a></p>
        </div>
      </div>
    </section>
  );
