...
import { applicabilityTerms, desc, governingLaw, liability, miscellaneous, paymentTerms, property, termination, useOfApp, warranty } from "../helper/termsData";
  ...
  return (
    <section className="privacy_policy-section">
      ...
      <div className="container mx-auto mt-10 mb-10">
        <div className="breadcrumb bg-[#F7F7F7] p-1 px-2 flex gap-x-3 justify-center rounded-md w-3/12 mb-4">
        ...
        <div className="p-6 shadow-inner">
          <p className="">
            ...
            owns BTHAWK, a GST Accounting and Billing Software application. The
            company makes the app available for download and let you use it on
            your Desktop and Mobile Phones as the end users of this app, subject
            to these terms and conditions.
          </p>
          <p className="mt-4">
            The company also handles a website{" "}
            <span className="text-[#0056b3]">BThawk</span> for branding,
            marketing, information and registration purposes only. It is thereby
            clarified that the company does not use the website for any purposes
            other than the listed purposes.
          </p>
          <p className="mt-4">
            ...
            by these terms. Together with the privacy policy, these terms add up
            to the entire rights, obligations and remedies, in respect to the
            use of this app and services.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            Any harm to any other specific requirement which may be laid out in
            these terms, your use of this app and specifically, your acceptance
            of these terms as above shall to be a representation from you that
            you are fully able to enter into the terms, conditions, obligations,
            declaration, representations and warranties that are set in these
            terms, and to comply with these terms.
          </p>
          <p className="mt-4">
            Headings and clauses are only for convenience and are not intended
            to be used to interpret the contents there under. Please read these
            terms fully.
          </p>
          <ol className="mt-4 list-decimal">
            ...
            <p className="mt-3">
              ...
              not limited to attorney’s fees) arising from: (i) your use of the
              App; (ii) your violation of any term of these Terms; (iii) your
              violation of any third party right, including without limitation
              any copyright, property, or privacy right. This indemnification
              obligation shall survive these Terms and use of the App.
            </p>
