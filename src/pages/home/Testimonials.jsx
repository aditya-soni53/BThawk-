...
export default function Testimonials() {
    ...
    const review = [
        ...
        },
        {
            ...
            review: "मेरा नाम सुरेश कुमार चंद्राकर है। मेरा फर्म का नाम साधना मोबाइल और मैं Airtel का डिस्ट्रीब्यूटर हूँ। मैं जिला -कवर्धा, छत्तीसगढ़ से हूँ। मेरा काम BTHAWK टीम द्वारा किया जा रहा है और इनकी सेवा बहुत अच्छी है और सराहनीय है।",
            client_img: reviewimg2
        },
        {
            id: 4,
            client_name: "RANJIT KUMAR SAHU (MAA TARINI TELECOM)",
            review: "मेरा नाम RANJIT KUMAR SAHU है। मेरे फर्म का नाम M/S MAA TARINI TELECOM है। इनकी सर्विसेज भी बहुत अच्छी है। मुझे इनके काम करने का तरीका पसंद है।से मेरा काम अच्छे से चल रहा है। मुझे कोई दिक्कत नहीं है।",
            client_img: reviewimg3
        },
        {
            id: 5,
            client_name: "Panchanan Swain (Swain Agency)",
            review: "Helo Team Mera Naam Panchanan Swain Hai. Mere Firm Ka Naam Swain Agency. Jab Se Mai Bthawk Se Juda Hu. Mera Kaam Ache Se Chal Rha Hai. Thanks Team 🙏🏻",
            client_img: reviewimg4
        },
        {
            id: 6,
            client_name: "VIJAY SINGH (MAA LAXMI COMMUNICATION)",
            review: "मेरा नाम VIJAY SINGH है। मेरे फर्म का नाम M/S JAY MAA LAXMI COMMUNICATION AND GENERAL STORE है। मेरा काम से बहुत अच्छे से चल रहा है। इनके काम से मुझे कोई परेशानी नहीं है। धन्यवाद",
            client_img: reviewimg7
        },
        {
            id: 7,
            client_name: "omprakash (Parvati agency)",
            review: "Mera nam omprakash hai or me Parvati agency se hu Muje aapki service bahut acchi lagi me aapki service se santusht hu",
            client_img: reviewimg
        },
        {
            id: 8,
            client_name: "VIRENDRA PANWAR (SANWARIYA AGENCY)",
            review: "MERA NAAM VIRENDRA PANWAR HAI. MERA FIRM NAME SANWARIYA AGENCY HAI. BTHAWK KI SERVICES BHUT ACHI HAI. MAI INKE KAAM SE BHUT SANTUSHT HU",
            client_img: reviewimg
        },
        {
            id: 9,
            client_name: "मुन्तज़र खान (M Traders)",
            review: "मेरा नाम मज़हर खान मुन्तज़र खान है।  मेरे फर्म का नाम M Traders है। मेरा काम BTHAWK से चल रहा है इनकी सर्विसेज बहुत अच्छी है।  मै इनके काम से बहुत खुश हु। और टीम का व्यव्हार भी बहुत अच्छा है।",
            client_img: reviewimg5
        },
        {
            id: 10,
            client_name: "RAJENDRA BENIWAL (SHREE GANESH COMPUTER AND MOBILE)",
            review: "Mera name RAJENDRA BENIWAL hai meri firm ka name SHREE GANESH COMPUTER AND MOBILE hai. Mera koi bthawk team dwara time par kiya ja rha hai. Mujhe aasha hai aap aage bhi aise hi sehyog krte rehenge.",
