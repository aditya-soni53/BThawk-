                   ...
                   <div className='aos-animate ' data-aos="fade-right">
                        ...
                        <div className="plan-toggle-wrap active mb-5">
                                ...
                                <div className="toggle-inner toggle-inner2">
                                    <input id="ce-toggle" checked={isYearly} type="checkbox" onChange={handleToggle} /> 
                                    <span className="custom-toggle"></span> <span className="t-month">Monthly</span>
                                    <span className="t-year">Yearly (Save 50%)</span> </div> <div className="price"> 
                                        {/* <p>{isYearly ? '₹2400 / year' : '₹240 / month'}</p>  */}
                                </div> 
                            </div>
                            <h2 className='text-3xl mb-5'>Choose the Right Plan for Your Business Success</h2>
                            <div className='mb-4'>
                                <b className='text-2xl mb-2 text-[#6851b1]'>Business Plan</b>
                                <p>Affordable and feature-rich for growing businesses. Simplify billing, inventory, and compliance with intuitive tools designed to scale your business seamlessly.</p>
                            </div>
                            <div className="mb-4">
                            <b className='text-2xl mb-2 text-[#9c4b21]'>Business Pro<sup className='text-xl'>+</sup> Plan</b>
                            <p>Comprehensive tools for advanced business needs. From automation to detailed reports, enjoy unmatched control, efficiency, and support to boost profitability and compliance.</p>
                            </div>
